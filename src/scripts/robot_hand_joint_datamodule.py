#!/usr/bin/env python3
"""
Robot Hand joint-angle regression DataModule
...
# ───────────────────────────────── heavyweight dataset
class RobotHandJointDataset(Dataset):
    def __init__(self,
                 root_dir: str,
                 num_points: int = 2048,
...
class RobotHandJointDataModule(pl.LightningDataModule):
    def __init__(self, *,
                 root_dir: str,
                 split_file: str,
                 ssd_cache_dir: str = "/mnt/disks/ssd/cache",
        ...
        self._base:   RobotHandJointDataset | None = None
    ...
    def setup(self, stage=None):
        ...
        # build dataset
        self._base = RobotHandJointDataset(
